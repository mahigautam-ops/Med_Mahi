    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          _toolButton(cp.isRecording ? Icons.stop_circle : Icons.circle_outlined, cp.isRecording ? 'Stop\nRec' : 'Record', () => cp.toggleRecording(), isActive: cp.isRecording),
        ],
      ),
    );
  }

  Widget _toolButton(IconData icon, String label, VoidCallback onTap, {bool isActive = false}) {
    return GestureDetector(
      onTap: onTap,
      child: Column(
        children: [
          Container(
            ...
            child: Icon(icon, color: isActive ? Colors.white : Colors.grey[600], size: 22),
          ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _activeToolButton(cp.isRecording ? Icons.stop_circle : Icons.circle_outlined, cp.isRecording ? 'Stop\nRec' : 'Record', () => cp.toggleRecording(), isActive: cp.isRecording),
